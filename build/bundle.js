...
exports.default = [_extends({}, _App2.default, { //this is the root component which will display the header etc.
  routes: [_extends({
    path: '/'
  }, _HomePage2.default, { //ES2015 spread syntax, gets everything in an object. Source and target keys must match
    exact: true
...
app.get('*', function (req, res) {
  ...
  var promises = (0, _reactRouterConfig.matchRoutes)(_routes2.default, req.path).map(function (_ref) {
    ...
    //wrap individual promise in another promise
    if (promise) {
...
//to create a custom axios instance
...
//we will create a higher order Component (HOC)
